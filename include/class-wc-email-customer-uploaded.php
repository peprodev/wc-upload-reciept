...
# @Last modified time: 2022/08/15 18:32:00
...
class WC_peproDev_UploadReceipt_Customer extends WC_Email
{
	/**
	...
	*/
	public function __construct()
	{
		...
		$this->title          = __('Uploaded Receipt to Customer', 'receipt-upload');
		$this->description    = __('An email sent to the customer when a receipt is uploaded.', 'receipt-upload');
		$this->heading        = __('Receipt Uploaded', 'receipt-upload');
		$this->subject        = sprintf(_x('[%s] Receipt Uploaded', 'receipt-uploaded-customer-subject', 'receipt-upload'), '{blogname}');
